...
// var sw = ServiceWorker.installing ;
// console.log("000")
// if ('serviceWorker' in navigator) {
...
fillCuisinesHTML = (cuisines = self.cuisines) => {
  ...
  cuisines.forEach(cuisine => {
    ...
    option.setAttribute('aria-lable',cuisine)
    select.append(option);
  });
}
...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoibWFuYWxtb2hhbW1lZCIsImEiOiJjanc0MWp2b2IwaWxrNDNzMGF4eGR1c2NnIn0.fapDbqaQjC-6MnrRwzjSrw',
    maxZoom: 18,
